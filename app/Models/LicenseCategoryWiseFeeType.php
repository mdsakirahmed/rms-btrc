    ...
    public static function boot()
    {
        ...
        self::created(function ($model) {
            activity()
                ...
                ->performedOn($model)
                ->useLog("create")
                ->log('Create license category wise fee type');
        });
            ...
            if ($changes) {
                foreach ($changes as $attr => $value) {
                    activity()
                        ...
                        ->performedOn($model)
                        ->useLog("edit")
                        ->log("Update license category wise fee type : $attr from {$model->getOriginal($attr)} to {$model->$attr}");
                }
            }
        });
        ...
        self::deleted(function ($model) {
            activity()
                ...
                ->log('Delete license category wise fee type');
        });
    }
}
