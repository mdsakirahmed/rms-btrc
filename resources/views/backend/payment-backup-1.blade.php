                        ...
                        <form action="{{ route('payment') }}" method="GET" class="row pt-3" id="payment_form">
                            ...
                            <div class="col-12 column receive_col">
                                <div class="row receive_row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group has-success">
                                            <label class="form-label required" for="">Late (<b class="late_fee_percentage_in_title">0</b>%)</label>
                                            <input type="number" class="form-control late_fee_receive" id="" name="late_fee_receive" step="0.001">
                                            <input type="hidden" class="late_fee" id="" name="late_fee" step="0.001">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.receive_col').on('change', '.fee_type', function () {
                ...
                if (new Date(receive_date).setHours(0, 0, 0, 0) > new Date(period_end_date).setHours(0, 0,
                    ...
                    $(this).closest(".receive_row").find('.late_fee_percentage_in_title').text(late_fee);
                    ...
                    $(this).closest(".receive_row").find('.late_fee_percentage_in_title').text(0);
                }
            });
        ...
        function calculation() {
            ...
            $('.receive_row').each(function (index, obj) {
                ...
                let late_fee_amount = (receive_amount / 100) * $(obj).find('.late_fee_receive').val();
