                        ...
                        <form action="{{ route('payment') }}" method="GET" class="row pt-3" id="payment_form">
                                    ...
                                    <select class="form-control form-select select2 filter sub_category" id="sub_category"
                                        ...
                                        @foreach ($sub_categories as $sub_category)
                                            <option value="{{ $sub_category->id }}"
                                                @if (request()->sub_category == $sub_category->id) selected @endif>
                                            ...
                                            <select class="form-control form-select select2 fee_type"
                                                ...
                                                @foreach ($fee_types as $fee_type)
                                                    <option value="{{ $fee_type->fee_type->id }}"
                                                        @if (request()->fee_type == $fee_type->fee_type->id) selected @endif>
                            ...
                            <div class="col-12 text-center">
                                <button type="button" id="payment_submit"
                                    class="btn waves-effect waves-light w-25 btn-success mt-4 mr-2">Submit Form</button>
    ...
    <script>
        ...
        function calculation() {
            ...
            $('.receive_row').each(function(index, obj) {
                ...
                total_amount_of_receive += parseFloat(receive_amount) + parseFloat(late_fee) + parseFloat(vat) +
                    parseFloat(tax);
            });
