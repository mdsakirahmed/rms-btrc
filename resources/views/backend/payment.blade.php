                    ...
                    <form action="{{ route('payment') }}" method="GET" class="row pt-3" id="payment_form">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="transaction" class="form-control transaction" placeholder="2203-name-01000" value="{{ date('ym') }}-{{ convert_to_initial(auth()->user()->name) }}-{{ sprintf("
                        ...
                        <div class="col-md-2">
                            <div class="form-group has-success">
                                ...
                                <select class="form-control form-select select2 filter sub_category" id="sub_category" name="sub_category">
                            ...
                            <div class="row receive_row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <input type="text" class="form-control schedule_date" id="" name="schedule_date" disabled>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <input type="number" class="form-control receive_amount" id="" name="receive_amount" step="0.001">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group has-success">
                            ...
                            <div class="row deposit_row">
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <input type="number" class="form-control deposit_amount" id="" placeholder="Deposit amount" name="deposit_amount" step="0.001">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        <label class="form-label required" for="">Deposit Journal No</label>
                                        <input type="text" class="form-control journal_number" id="" placeholder="Journal number" name="journal_number">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                        ...
                        <div class="col-12 d-flex flex-row-reverse bd-highlight">
                            <div class="p-2 bd-highlight fw-bold">Total Deposit Amount is: <b id="total_amount_of_deposit">0</b> BDT</div>
                        </div>
...
<div class="modal bs-example-modal-lg fade" id="payment_repeipt_modal" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title" id="">Payment Receipt</h4>
                <button type="button" class="btn-close" onClick="window.location.reload()" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
