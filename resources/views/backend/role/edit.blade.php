        ...
        <div class="col-md-12">
            <div class="card border-info">
                <div class="card-header bg-success">
                    <h4 class="m-b-0 text-white">Update role</h4></div>
                <div class="card-body">
                        ...
                        <form action="{{ route('role.update', $role) }}" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 has-success">
                                    <input type="text" id="role" name="role" class="form-control form-control-lg" placeholder="Name of new role" value="{{ $role->name }}">
                                    @error('role')
                            ...
                            @foreach($permissions as $permission)
                                <label class="btn btn-success active">
                                    <div class="custom-control custom-checkbox mr-sm-2">
                                        <input type="checkbox" class="custom-control-input" name="permissions[]" value="{{ $permission->name }}" id="permission-{{ $loop->iteration }}" @if($role->hasPermissionTo($permission->name)) checked="" @endif>
