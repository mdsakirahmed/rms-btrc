        ...
        <div class="col-md-12">
            <div class="card border-info">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Update user permissions</h4></div>
                <div class="card-body">
                            ...
                            @foreach($permissions as $permission)
                                <label class="btn btn-info active">
                                    <div class="custom-control custom-checkbox mr-sm-2">
                                        <input type="checkbox" class="custom-control-input" name="permissions[]" value="{{ $permission->name }}" id="permission-{{ $loop->iteration }}" @if($user->hasPermissionTo($permission->name)) checked="" @endif>
