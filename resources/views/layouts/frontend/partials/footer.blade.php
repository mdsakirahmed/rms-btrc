<footer class="site-footer footer-dark bg-no-repeat bg-full-height bg-center "  style="background-image:url(assets/frontend/images/background/footer-bg.jpg);">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget_about">
                        ...
                        <div class="logo-footer clearfix p-b15">
                            <a href="index.html"><img src="assets/frontend/assets/frontend/images/footer-logo.png" width="230" height="67" alt=""/></a>
                        </div>
        ...
        <div class="container p-t30">
            <div class="row">
                <div class="wt-footer-bot-left">
                    <span class="copyrights-text">© 2018 Your Company. All Rights Reserved. Designed By thewebmax.</span>
                </div>
