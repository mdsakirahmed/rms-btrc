                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control form-control-lg" id="name" placeholder="Operator name" aria-label="" wire:model="name">
                        ...
                        <table class="table color-table success-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $operator->name }}</td>
                                    <td title="{{ $operator->created_at->format('d/m/Y h:i A') }}">{{ $operator->created_at->diffForHumans() }}</td>
                                    <td>
                                        <button type="button" class="btn btn-primary" wire:click="selectForEdit({{ $operator->id }})">Edit</button>
                                        <button type="button" class="btn btn-danger text-white" wire:click="selectForDelete({{ $operator->id }})" onclick="openModal()"> Delete </button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
