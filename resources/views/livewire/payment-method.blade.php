<div>
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Payment Method Page</h4>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control form-control-lg" id="name" placeholder="Payment Method name" aria-label="" wire:model="name">
                        ...
                        <table class="table color-table success-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td title="{{ $paymentMethod->created_at->format('d/m/Y h:i A') }}">{{ $paymentMethod->created_at->diffForHumans() }}</td>
                                    <td>
                                        <button type="button" class="btn btn-primary" wire:click="selectForEdit({{ $paymentMethod->id }})">Edit</button>
                                        <button type="button" class="btn btn-danger text-white" wire:click="selectForDelete({{ $paymentMethod->id }})" onclick="openModal()"> Delete </button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
