            ...
            <div class="card">
                <div class="card-body">
                    <form wire:submit.prevent="submit">
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="name">Payment Receive</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control form-control-lg" id="name" placeholder="Payment Receive name" aria-label="" wire:model="name">
                        ...
                        <table class="table color-table success-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $paymentReceive->name }}</td>
                                    <td title="{{ $paymentReceive->created_at->format('d/m/Y h:i A') }}">{{ $paymentReceive->created_at->diffForHumans() }}</td>
                                    <td>
