<div>
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Receive period Page</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb justify-content-end">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Receive period Page</li>
                </ol>
            ...
            <div class="card">
                <div class="card-body">
                    <form wire:submit.prevent="submit">
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="name">Receive period</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control form-control-lg" id="name" placeholder="Receive period name" aria-label="" wire:model="name">
                        ...
                        <table class="table color-table success-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $receive_period->name }}</td>
                                    <td title="{{ $receive_period->created_at->format('d/m/Y h:i A') }}">{{ $receive_period->created_at->diffForHumans() }}</td>
                                    <td>
                                        <button type="button" class="btn btn-primary" wire:click="selectForEdit({{ $receive_period->id }})">Edit</button>
                                        <button type="button" class="btn btn-danger text-white" wire:click="selectForDelete({{ $receive_period->id }})" onclick="openModal()"> Delete </button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
