        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-5">
                        <div class="col-3">
                            <input type="date" class="form-control @error('starting_date') border-danger @endif" wire:model="starting_date" title="PO Starting Date">
                        </div>
                        <div class="col-3">
                            <input type="date" class="form-control @error('ending_date') border-danger @endif" wire:model="ending_date" title="PO Ending Date">
                        </div>
                        <div class="col-3">
